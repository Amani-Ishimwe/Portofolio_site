...
const Testimonials = () => {
  ...
  return (
    <section
      ...
      before:bg-[linear-gradient(to_right,rgba(255,255,255,0.08)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.08)_1px,transparent_1px)]
    ...
    >
      <div className="container mx-auto relative z-10">
        ...
        <div className="max-w-4xl mx-auto relative overflow-hidden h-[380px]">
          <AnimatePresence custom={direction}>
            ...
            >
              <div className="card bg-dark-900/70 backdrop-blur-md border border-white/10 px-8 py-10 rounded-2xl shadow-lg">
                {/* Quote Icon */}
